...
const ACCOUNTRS = "MUNHU-9C5A-J3PY-UEG3-7BK77";
      ...
      it("should verify created transaction bytes", () => {
        ...
        const transactionJSON = {
          ...
          "attachment": {
              ...
              "priceMTAPerShare": "100",
              "version.BidOrderPlacement": 1
          },
          "senderRS": "MUNHU-9C5A-J3PY-UEG3-7BK77",
          "subtype": 3,
          "amountMTA": "0",
    ...
    describe("verifyTransactionBytes V2", () => {
      it("should verify created transaction bytes", () => {
        ...
        const transactionJSON = {
            ...
            "senderRS": "MUNHU-9C5A-J3PY-UEG3-7BK77",
            "subtype": 0,
            "amountMTA": "1300000000",
            "sender": "5950989589159323752",
            "recipientRS": "MUNHU-9C5A-J3PY-UEG3-7BK77",
